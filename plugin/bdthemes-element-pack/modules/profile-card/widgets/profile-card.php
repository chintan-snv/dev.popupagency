...
class Profile_Card extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				'label'       => esc_html__( 'Posts Number', 'bdthemes-element-pack' ),
				'type'        => Controls_Manager::TEXT,
		...
		$this->add_control(
			...
			[
				'label'       => esc_html__( 'Followers Number', 'bdthemes-element-pack' ),
				'type'        => Controls_Manager::TEXT,
		...
		$this->add_control(
			...
			[
				'label'       => esc_html__( 'Following Number', 'bdthemes-element-pack' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( '213' , 'bdthemes-element-pack' ),
			]
		);
		...
		<div class="bdt-profile-card">
            <div class="bdt-profile-card-item">
                ...
                <div class="bdt-profile-card-inner bdt-text-<?php echo esc_attr($settings['alignment']); ?>">
					...
					<?php if ($settings['show_button']) : ?>
                    <div class="bdt-profile-button bdt-margin-medium-top bdt-margin-medium-bottom">
                        <a class="bdt-button bdt-button-secondary" href="#"><?php echo $settings['profile_button_text']; ?></a>
                    </div>
                    <?php endif; ?>
