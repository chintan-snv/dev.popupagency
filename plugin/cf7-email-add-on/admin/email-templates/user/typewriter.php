																			...
																			<tr>
																				<td>
																					<div style="text-align: center;">
																						<a href="https://www.krishaweb.com/blog" style="display: inline-block; padding: 12px 20px 12px 20px; background: #358CD3; color: #ffffff; font-size: 20px; text-decoration: none; font-family: Courier, Courier New, monospace, Arial; font-weight: bold; text-transform: uppercase; letter-spacing: 0.050em;">fresh from blog</a>
																					</div>
																				</td>
																			</tr>
																		</tbody>
