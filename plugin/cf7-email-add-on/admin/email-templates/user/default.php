												...
												<td>
													<table width="100%" bgcolor="#ffffff" cellpadding="0" cellspacing="0" border="0" style="width: 100%; max-width: 620px; margin: 0 auto; background: #ffffff;">
														<tbody>
															...
															<tr>
																<td>
																	<img src="[plugin_url]admin/assets/images/banner.jpg" alt="" style="width: 100%; display: block;">
																</td>
															</tr>
															<tr>
																<td>
																							...
																							<tr>
																								<td>
																									<div style="text-align: center;">
																										<a href="https://www.krishaweb.com/blog" style="display: inline-block; padding: 12px 20px 12px 20px; background: #1ca1ec; color: #ffffff; text-decoration: none; font-family: Verdana, sans-serif; text-transform: uppercase; font-weight: 500; letter-spacing: 0.050em;">fresh from blog</a>
																									</div>
																								</td>
																							</tr>
																							<tr>
									...
									<table width="100%" cellpadding="0" cellspacing="0" border="0" style="">
										<tr>
											<td style="font-family: Verdana, sans-serif; font-weight: normal; font-size: 14px; line-height: 24px; color: #3e3e3e; text-align: left; padding-bottom: 30px; padding-top: 15px;">
												Copyright © 2018 <a href="https://www.krishaweb.com/" target="_blank" style="text-decoration: none; color: #1a1f8e">KrishaWeb</a>
											</td>
