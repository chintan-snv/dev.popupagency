										...
										<tbody>
											<tr>
												<td height="400" bgcolor="#37B5CE" style="background-image: url([plugin_url]admin/assets/images/banner-bg.jpg); background-repeat: no-repeat; background-color: #37B5CE; text-align: center; font-family: Courier, Courier New, monospace, Arial; padding: 0 25px;">
													<img src="[plugin_url]admin/assets/images/icon.png" alt="" style="display: inline-block;">
													<span style="display: block; color: #ffffff; font-size: 20px; font-weight: bold; letter-spacing: 0.050em; text-align: left; margin-bottom: 10px; padding-top: 40px;"> Hi, Administrator</span>
													<p style="margin: 5px 0 10px; font-family: Verdana, sans-serif; text-align: left; color: #ffffff;">We have an incoming lead for you.</p>
													<p style="margin: 5px 0 0; font-family: Verdana, sans-serif; text-align: left; color: #ffffff;">See the detail of the lead below.</p>
												</td>
											</tr>
											<tr>
												<td bgcolor="#ffffff">
															...
															<tr>
																<td bgcolor="#F6F6F6" style="padding: 15px;">
																	<table cellpadding="0" cellspacing="0" width="100%">
																		<tr>
																			<td>
																				<a href="https://www.krishaweb.com" target="_blank" style="display: inline-block;"><img src="[plugin_url]admin/assets/images/default-logo.png" alt=""></a>
																			</td>
					...
					<table width="100%" cellpadding="0" cellspacing="0" border="0" style="">
						<tr>
							<td style="font-family: Courier, Courier New, monospace, Arial; font-weight: normal; font-size: 14px; line-height: 24px; color: #444444; text-align: left; padding-bottom: 30px; padding-top: 15px; padding-left: 15px; padding-right: 15px;">
								Copyright © 2018 <a href="https://www.krishaweb.com/" target="_blank" style="text-decoration: none; font-weight: bold; color: #444444">KrishaWeb</a>
							</td>
