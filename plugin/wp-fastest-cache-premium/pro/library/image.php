	...
	class WpFastestCacheImageOptimisation{
		...
		public function set_server_location(){
			if(isset($_GET["location"]) && $_GET["location"]){
				...
				}else if($_GET["location"] == "du"){
					$this->location = "https://api.wpfcde.tk";


				}else if($_GET["location"] == "az"){
					$this->location = "https://api.wpfcarizona.tk";
				}else if($_GET["location"] == "chic"){
					$this->location = "https://api.wpfcchicago.tk";
				}else if($_GET["location"] == "it"){
					$this->location = "https://api.wpfcmilan.tk";
				}else if($_GET["location"] == "jp"){
					$this->location = "https://api.wpfcjp.tk";
