...
function sppro_is_valid_locale( $locale ) {
	$pattern = '/^[a-z]{2,3}(?:_[a-zA-Z_]{2,})?$/';
	return (bool) preg_match( $pattern, $locale );
}

function sppro_is_rtl( $locale = '' ) {
...
function sppro_load_textdomain( $locale = null ) {
	global $l10n;

	$domain = 'sp-pro-txt-domain';
