...
class Buddypress {
	...
	public function enqueue_scripts() {
		...
		$suffix = is_rtl() ? '-rtl' : '';
		wp_enqueue_style( 'mylisting-buddypress', c27()->template_uri( 'assets/dist/buddypress'.$suffix.'.css' ), [], CASE27_THEME_VERSION );
		wp_enqueue_script( 'mylisting-buddypress', c27()->template_uri( 'assets/dist/buddypress.js' ), ['jquery'], CASE27_THEME_VERSION, true );
	}
