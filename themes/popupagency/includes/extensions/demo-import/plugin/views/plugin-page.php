...
<div class="ocdi  wrap  about-wrap">
	...
	<p class="ocdi__ajax-loader  js-ocdi-ajax-loader">
		<span class="spinner"></span> <?php esc_html_e( 'Importing, please wait! Import can take a couple of minutes, do not close this page until you see a notice.', 'pt-ocdi' ); ?>
	</p>
