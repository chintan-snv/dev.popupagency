...
$presets = MyListing\Src\Forms\Fields\Presets::get( $type );
// dd($config);
// dd(wp_json_encode($config['settings'], JSON_PRETTY_PRINT));
?>
...
<script type="text/javascript">
	...
	window.Type_Editor_Data = {
		preset_fields: <?php echo wp_json_encode( $presets ) ?>,
		custom_fields: <?php echo wp_json_encode( $designer->get_field_types() ) ?>,
		content_tabs: <?php echo wp_json_encode( $designer->get_tab_types() ) ?>,
		content_blocks: <?php echo wp_json_encode( $designer->get_block_types() ) ?>,
	};
</script>
