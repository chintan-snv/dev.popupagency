...
class Switch_Package {
	...
	public function display_switch_action( $listing ) {
		...
		$switch_sub = apply_filters( 'mylisting/enable-subscription-switch', false );
		if ( $switch_sub && $product && $product->is_type( 'job_package_subscription' ) && class_exists( '\WC_Subscriptions_Switcher' ) ) {
