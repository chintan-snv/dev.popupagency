...
class Preview_Cards {
	...
	public function __construct() {
		...
		add_action( 'mylisting/options-page:preview-cards', [ $this, 'render_settings' ] );
	...
	public function render_settings() {
		...
		require locate_template( 'templates/admin/theme-options/preview-cards.php' );
	}
	...
	public function refresh_cache_for_listing( $listing_id ) {
	...
	public function refresh_cache_for_listing_and_relations( $listing_id ) {
		...
		$this->refresh_cache_for_listing( $listing->get_id() );
