...
class Assets {
	...
	public function register_scripts() {
		...
		// new frontend custom styles
		wp_register_style( 'custom-frontend', c27()->template_uri( 'assets/dist/mwb-custom-style.css' ), [], '1.0.5' );
	...
	public function enqueue_scripts() {
		global $wp_query;
		$show = array(
			'valda_plat' =>	__('vald plats','my-listing'),
			'valda_plats' => __('valda plater','my-listing'),
			'plats' =>__('Plats','my-listing'),
			'vald_lokaltyp' => __('vald lokaltyp','my-listing'),
			'valda_lokaltyper' => __('valda lokaltyper','my-listing'),
			'lokaltyp' 		=> __('Lokaltyp','my-listing'),
			'valda_amenities' => __('valda Amenities','my-listing'),
			'amenities' => __('Amenities','my-listing'),
			'load' => __('Load More','my-listing'),
		...
		//wp_enqueue_style( 'vuejs' );		
		
		// Frontend scripts.
		//wp_enqueue_script( 'mylisting-vendor', c27()->template_uri( 'assets/dist/vendor.js' ), ['jquery'], CASE27_THEME_VERSION, true );
		//wp_enqueue_script( 'c27-main-frontendpopup', c27()->template_uri( 'assets/dist/frontend.js' ), ['jquery'], CASE27_THEME_VERSION, true );
		// Frontend scripts.
		wp_enqueue_script( 'mylisting-vendor', c27()->template_uri( 'assets/dist/vendor.js' ), ['jquery'], CASE27_THEME_VERSION, true );
		wp_enqueue_script('mylisting-explore');
		//wp_enqueue_script('vuejs');
		wp_enqueue_script( 'vuejs', 'https://cdnjs.cloudflare.com/ajax/libs/vue/1.0.18/vue.min.js', ['jquery'], CASE27_THEME_VERSION, true );
		wp_enqueue_script( 'mCustomScrollbar-js', 'https://cdn.jsdelivr.net/jquery.mcustomscrollbar/3.0.6/jquery.mCustomScrollbar.concat.min.js', ['jquery'], CASE27_THEME_VERSION, true );
		 wp_enqueue_script( 'c27-main', c27()->template_uri( 'assets/dist/frontend.js' ), ['jquery'], CASE27_THEME_VERSION, true );
		
		//wp_enqueue_script( 'c27-main', c27()->template_uri( 'assets/dist/frontend-popup.js' ), ['jquery'], time(), true );

		wp_localize_script('c27-main','frontend_popup_param', $show );
		wp_enqueue_script( 'mwb-custom-js', c27()->template_uri( 'assets/dist/mwb-custom-script.js' ), ['jquery','c27-main'], '1.6', true );
		...
		wp_enqueue_style( 'custom-frontend' );
		// theme style.css
