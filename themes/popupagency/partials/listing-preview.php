...
//     print_r($wp);
// }
if(isset($wp->query_vars['page']) && $wp->query_vars['page'] != 'lediga-lokaler' && $wp->query_vars != ''){
    $show = 'my-listing-custom-other mwb_my_listings_wrapper';
}else{
    $show = 'my-listing-custom';
}
...
$listing_thumbnail = $listing->get_logo( 'thumbnail' ) ?: c27()->image( 'marker.svg' );
$latitude = false;
$longitude = false;
