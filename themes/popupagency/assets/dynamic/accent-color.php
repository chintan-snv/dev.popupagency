...
.altbtn.btn-primary, .altbtn.btn-primary:hover, .altbtn.btn-primary:active, .altbtn.btn-primary:focus { background-color: <?php echo $brand ?>; }
.altbtn, .altbtn:hover, .altbtn:active, .altbtn:focus { color: <?php echo $brand ?>; }
...
.promo-item-icon i, #buddypress div#item-buttons a.join-group:hover,
